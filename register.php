		...
		<div id= "loginContainer">
			...
			<div id= "inputContainer">
				<form id="loginForm" action="register.php" method="POST">
					...
					<button class="btn-landing" type="submit" name="loginButton"><span>LOG IN</span></button>

					<div class = "hasAccountText">
						<span id="hideLogin">Don't have an account yet? <span id="signup">Signup here</span></span>
					</div>
				</form>
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<button class="btn-landing" type="submit" name="registerButton"><span>SIGN UP</span></button>
